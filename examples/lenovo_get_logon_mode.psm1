###
#
# Lenovo Redfish examples - Get logon mode
#
# Copyright Notice:
#
...
function lenovo_get_logon_mode
{
   <#
   .Synopsis
    Cmdlet used to get logon mode
   .DESCRIPTION
    Cmdlet used to get logon mode using Redfish API
   ...
   .EXAMPLE
    lenovo_get_logon_mode -ip 10.10.10.10 -username USERID -password PASSW0RD -
   #>
    ...
    try
    {
        ...
        # Get the BMC logon mode
        $logon_mode['AuthenticationMethod'] = $converted_object.Oem.Lenovo.AuthenticationMethod
        $logon_mode
    }
    catch
    {
