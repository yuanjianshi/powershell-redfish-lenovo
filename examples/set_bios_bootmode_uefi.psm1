###
#
# Lenovo Redfish examples - Set bios bootmode uefi
#
# Copyright Notice:
#
...
function set_bios_bootmode_uefi
{
    <#
    .Synopsis
     Cmdlet user to set bios bootmode uefi
    .DESCRIPTION
     Cmdlet used to set bios bootmode uefi form BMC using Redfish API. Set result will be printed to the screen.
